...
// === BRAM Port-B native interface (to top) ===

// AFTER (fabric drives the port; PS wrapper passes through):
input  [31:0] bram_b_addr,
input         bram_b_clk,
input  [31:0] bram_b_din,
output [31:0] bram_b_dout,
input         bram_b_en,
input         bram_b_rst,
input  [3:0]  bram_b_we,

// AXI DMA MM2S Stream outputs from PS/BD
output wire [31:0] M_AXIS_MM2S_0_tdata,
output wire [3:0]  M_AXIS_MM2S_0_tkeep,   // width from your wrapper
output wire        M_AXIS_MM2S_0_tlast,
input  wire        M_AXIS_MM2S_0_tready,
output wire        M_AXIS_MM2S_0_tvalid,
  //Placing extenal clock port in system:
input    wire      adc_clk_i 
  ...
  //new
//wire [23:0] gpio_bidir;
//assign gpio_bidir = gpio.t ? gpio.o : 24'bz;
//assign gpio.i = gpio_bidir;
...
// Drive GP1 ACLK/ARESETN from PS FCLK3 domain
//assign M_AXI_GP1_ACLK    = fclk_clk[2];
//assign M_AXI_GP1_ARESETN = fclk_rstn[2];
...
system_wrapper system_i (
   ...
   // HP0
.S_AXI_HP0_aclk     (hp0_saxi.ACLK),
.S_AXI_HP0_araddr   (hp0_saxi.ARADDR),
.S_AXI_HP0_arburst  (hp0_saxi.ARBURST),
.S_AXI_HP0_arcache  (hp0_saxi.ARCACHE),
.S_AXI_HP0_arid     (hp0_saxi.ARID),
.S_AXI_HP0_arlen    (hp0_saxi.ARLEN),
.S_AXI_HP0_arlock   (hp0_saxi.ARLOCK),
.S_AXI_HP0_arprot   (hp0_saxi.ARPROT),
.S_AXI_HP0_arqos    (hp0_saxi.ARQOS),
.S_AXI_HP0_arready  (hp0_saxi.ARREADY),
.S_AXI_HP0_arsize   (hp0_saxi.ARSIZE),
.S_AXI_HP0_arvalid  (hp0_saxi.ARVALID),

.S_AXI_HP0_awaddr   (hp0_saxi.AWADDR),
.S_AXI_HP0_awburst  (hp0_saxi.AWBURST),
.S_AXI_HP0_awcache  (hp0_saxi.AWCACHE),
.S_AXI_HP0_awid     (hp0_saxi.AWID),
.S_AXI_HP0_awlen    (hp0_saxi.AWLEN),
.S_AXI_HP0_awlock   (hp0_saxi.AWLOCK),
.S_AXI_HP0_awprot   (hp0_saxi.AWPROT),
.S_AXI_HP0_awqos    (hp0_saxi.AWQOS),
.S_AXI_HP0_awready  (hp0_saxi.AWREADY),
.S_AXI_HP0_awsize   (hp0_saxi.AWSIZE),
.S_AXI_HP0_awvalid  (hp0_saxi.AWVALID),

.S_AXI_HP0_bid      (hp0_saxi.BID),
.S_AXI_HP0_bready   (hp0_saxi.BREADY),
.S_AXI_HP0_bresp    (hp0_saxi.BRESP),
.S_AXI_HP0_bvalid   (hp0_saxi.BVALID),

.S_AXI_HP0_rdata    (hp0_saxi.RDATA),
.S_AXI_HP0_rid      (hp0_saxi.RID),
.S_AXI_HP0_rlast    (hp0_saxi.RLAST),
.S_AXI_HP0_rready   (hp0_saxi.RREADY),
.S_AXI_HP0_rresp    (hp0_saxi.RRESP),
.S_AXI_HP0_rvalid   (hp0_saxi.RVALID),

.S_AXI_HP0_wdata    (hp0_saxi.WDATA),
.S_AXI_HP0_wid      (hp0_saxi.WID),
.S_AXI_HP0_wlast    (hp0_saxi.WLAST),
.S_AXI_HP0_wready   (hp0_saxi.WREADY),
.S_AXI_HP0_wstrb    (hp0_saxi.WSTRB),
.S_AXI_HP0_wvalid   (hp0_saxi.WVALID),

// HP2
.S_AXI_HP2_aclk     (hp2_saxi.ACLK),
.S_AXI_HP2_araddr   (hp2_saxi.ARADDR),
.S_AXI_HP2_arburst  (hp2_saxi.ARBURST),
.S_AXI_HP2_arcache  (hp2_saxi.ARCACHE),
.S_AXI_HP2_arid     (hp2_saxi.ARID),
.S_AXI_HP2_arlen    (hp2_saxi.ARLEN),
.S_AXI_HP2_arlock   (hp2_saxi.ARLOCK),
.S_AXI_HP2_arprot   (hp2_saxi.ARPROT),
.S_AXI_HP2_arqos    (hp2_saxi.ARQOS),
.S_AXI_HP2_arready  (hp2_saxi.ARREADY),
.S_AXI_HP2_arsize   (hp2_saxi.ARSIZE),
.S_AXI_HP2_arvalid  (hp2_saxi.ARVALID),

.S_AXI_HP2_awaddr   (hp2_saxi.AWADDR),
.S_AXI_HP2_awburst  (hp2_saxi.AWBURST),
.S_AXI_HP2_awcache  (hp2_saxi.AWCACHE),
.S_AXI_HP2_awid     (hp2_saxi.AWID),
.S_AXI_HP2_awlen    (hp2_saxi.AWLEN),
.S_AXI_HP2_awlock   (hp2_saxi.AWLOCK),
.S_AXI_HP2_awprot   (hp2_saxi.AWPROT),
.S_AXI_HP2_awqos    (hp2_saxi.AWQOS),
.S_AXI_HP2_awready  (hp2_saxi.AWREADY),
.S_AXI_HP2_awsize   (hp2_saxi.AWSIZE),
.S_AXI_HP2_awvalid  (hp2_saxi.AWVALID),

.S_AXI_HP2_bid      (hp2_saxi.BID),
.S_AXI_HP2_bready   (hp2_saxi.BREADY),
.S_AXI_HP2_bresp    (hp2_saxi.BRESP),
.S_AXI_HP2_bvalid   (hp2_saxi.BVALID),

.S_AXI_HP2_rdata    (hp2_saxi.RDATA),
.S_AXI_HP2_rid      (hp2_saxi.RID),
.S_AXI_HP2_rlast    (hp2_saxi.RLAST),
.S_AXI_HP2_rready   (hp2_saxi.RREADY),
.S_AXI_HP2_rresp    (hp2_saxi.RRESP),
.S_AXI_HP2_rvalid   (hp2_saxi.RVALID),

.S_AXI_HP2_wdata    (hp2_saxi.WDATA),
.S_AXI_HP2_wid      (hp2_saxi.WID),
.S_AXI_HP2_wlast    (hp2_saxi.WLAST),
.S_AXI_HP2_wready   (hp2_saxi.WREADY),
.S_AXI_HP2_wstrb    (hp2_saxi.WSTRB),
.S_AXI_HP2_wvalid   (hp2_saxi.WVALID),

// HP3
.S_AXI_HP3_aclk     (hp3_saxi.ACLK),
.S_AXI_HP3_araddr   (hp3_saxi.ARADDR),
.S_AXI_HP3_arburst  (hp3_saxi.ARBURST),
.S_AXI_HP3_arcache  (hp3_saxi.ARCACHE),
.S_AXI_HP3_arid     (hp3_saxi.ARID),
.S_AXI_HP3_arlen    (hp3_saxi.ARLEN),
.S_AXI_HP3_arlock   (hp3_saxi.ARLOCK),
.S_AXI_HP3_arprot   (hp3_saxi.ARPROT),
.S_AXI_HP3_arqos    (hp3_saxi.ARQOS),
.S_AXI_HP3_arready  (hp3_saxi.ARREADY),
.S_AXI_HP3_arsize   (hp3_saxi.ARSIZE),
.S_AXI_HP3_arvalid  (hp3_saxi.ARVALID),

.S_AXI_HP3_awaddr   (hp3_saxi.AWADDR),
.S_AXI_HP3_awburst  (hp3_saxi.AWBURST),
.S_AXI_HP3_awcache  (hp3_saxi.AWCACHE),
.S_AXI_HP3_awid     (hp3_saxi.AWID),
.S_AXI_HP3_awlen    (hp3_saxi.AWLEN),
.S_AXI_HP3_awlock   (hp3_saxi.AWLOCK),
.S_AXI_HP3_awprot   (hp3_saxi.AWPROT),
.S_AXI_HP3_awqos    (hp3_saxi.AWQOS),
.S_AXI_HP3_awready  (hp3_saxi.AWREADY),
.S_AXI_HP3_awsize   (hp3_saxi.AWSIZE),
.S_AXI_HP3_awvalid  (hp3_saxi.AWVALID),

.S_AXI_HP3_bid      (hp3_saxi.BID),
.S_AXI_HP3_bready   (hp3_saxi.BREADY),
.S_AXI_HP3_bresp    (hp3_saxi.BRESP),
.S_AXI_HP3_bvalid   (hp3_saxi.BVALID),

.S_AXI_HP3_rdata    (hp3_saxi.RDATA),
.S_AXI_HP3_rid      (hp3_saxi.RID),
.S_AXI_HP3_rlast    (hp3_saxi.RLAST),
.S_AXI_HP3_rready   (hp3_saxi.RREADY),
.S_AXI_HP3_rresp    (hp3_saxi.RRESP),
.S_AXI_HP3_rvalid   (hp3_saxi.RVALID),

.S_AXI_HP3_wdata    (hp3_saxi.WDATA),
.S_AXI_HP3_wid      (hp3_saxi.WID),
.S_AXI_HP3_wlast    (hp3_saxi.WLAST),
.S_AXI_HP3_wready   (hp3_saxi.WREADY),
.S_AXI_HP3_wstrb    (hp3_saxi.WSTRB),
.S_AXI_HP3_wvalid   (hp3_saxi.WVALID),
...
// BRAM Port-B native pins (exact names from system_wrapper.v)
  .BRAM_PORTB_0_addr (bram_b_addr),
  .BRAM_PORTB_0_clk  (bram_b_clk),
  .BRAM_PORTB_0_din  (bram_b_din),
  .BRAM_PORTB_0_dout (bram_b_dout),
  .BRAM_PORTB_0_en   (bram_b_en),
  .BRAM_PORTB_0_rst  (bram_b_rst),
  .BRAM_PORTB_0_we   (bram_b_we)
