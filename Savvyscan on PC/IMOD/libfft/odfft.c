...
/*!
 * Returns 1 if FFTW or MKL is being used, 0 if IMOD FFT library is being used
 */
int usingFFTW(void)
{
  return 0;
...
/*!
 * Returns the highest desirable prime factor, 13 for FFTW/MKL and 5 for IMOD FFTs.
 * For IMOD FFTs, the highest allowed prime factor is 19.
 */
