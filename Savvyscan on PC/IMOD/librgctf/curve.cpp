...
void LS_POLY(float *x_data, float *y_data, int number_of_points, int order_of_polynomial, float *output_smoothed_curve, float *output_coefficients)
{
  /* IMOD icl 11 switch to allocations
	...
	double x[number_of_points + 1];
	double y[number_of_points + 1];*/
	double *a = new double[order_of_polynomial + 2];
	double *b = new double[order_of_polynomial + 2];
	double *c = new double[order_of_polynomial + 3];
	double *c2 = new double[order_of_polynomial + 2];
	double *f = new double[order_of_polynomial + 2];

	double *v = new double[number_of_points + 1];
	double *d = new double[number_of_points + 1];
	double *e = new double[number_of_points + 1];
	double *x = new double[number_of_points + 1];
	double *y = new double[number_of_points + 1];
