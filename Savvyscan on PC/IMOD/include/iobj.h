 ...
 *
 *  Copyright (C) 1995-2018 by Regents of the University of 
...
#define IMOD_OBJFLAG_DRAW_LABEL (1l << 27) /* Draw labels on image           */
#define IMOD_OBJFLAG_SCALE_WDTH (1l << 28) /* Scale line width by DPI scaling  */
...
#define IOBJ_EX_LABEL_SIZE 2
#define IOBJ_EX_FLAGS      3
#define IOBJ_EX_LASSO_ID   (IOBJ_EXSIZE - 1)

/* Flags in extra[IOBJ_EX_FLAGS] */
#define IOBJ_EXFLAG_ISO_PAINT 1
