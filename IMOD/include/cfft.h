...
/* Header file for C translation of FFT library and wrapper to FFTW/MKL */
...
/* Uncomment for timing measurements and output in old FFT 
 BUT THEN it uses transposition only with environment variable TRANSPOSE defined */
/*#define OLD_FFT_TIMES */
#ifdef OLD_FFT_TIMES
#include "b3dutil.h"
#include "mrcslice.h"
#endif
