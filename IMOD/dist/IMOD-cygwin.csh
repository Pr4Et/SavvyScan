...
# Specify the location of plugins if any, ignoring a setting in a Windows installation
#
if ($?IMOD_PLUGIN_DIR) then
    if ("$IMOD_PLUGIN_DIR" == 'C:\Program Files\IMOD\lib\imodplug') unsetenv IMOD_PLUGIN_DIR
endif
...
#
if ($?IMOD_CALIB_DIR) then
    if ("$IMOD_CALIB_DIR" == 'C:\ProgramData\IMOD') unsetenv IMOD_CALIB_DIR
endif
