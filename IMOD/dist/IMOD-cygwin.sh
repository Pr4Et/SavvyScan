...
#
if [ -n "$IMOD_PLUGIN_DIR" ] && [ "$IMOD_PLUGIN_DIR" == 'C:\Program Files\IMOD\lib\imodplug' ] ; then 
...
#
if [ -n "$IMOD_CALIB_DIR" ] && [ "$IMOD_CALIB_DIR" == 'C:\ProgramData\IMOD' ] ; then 
    unset IMOD_CALIB_DIR
fi
