...
program reducemont
  ...
  call memoryErrorUC(ierr, 'INITIAL ARRAYS')
...
!
  ...
  call memoryErrorUC(ierr, 'ARRAYS PER PIECE')
  !
  ...
  call memoryErrorUC(ierr, 'ARRAYS PER SECTION')
...
18 modeOut = modeIn
  ...
  call memoryErrorUC(ierr, 'OUTPUT LINE ARRAY')
  !
  ...
  call memoryErrorUC(ierr, 'ARRAYS FOR PIECE BUFFER')
  ...
  if (loadLines) then
    ...
    call memoryErrorUC(ierr, 'MAIN IMAGE ARRAY; TRY SMALLER OUTPUT FRAME SIZE IN Y')
  else
    !
    ...
    call memoryErrorUC(ierr, 'MAIN IMAGE ARRAY')
  endif
    ...
    do ilong = 1, nlong
      ...
      do ishort = 1, nshort
        ...
        if (anyPixels) then
          ...
          !
          write(3, '(2i9,i7)') newPieceXll, newPieceYll, izSect
        endif
        !
      enddo
    enddo
