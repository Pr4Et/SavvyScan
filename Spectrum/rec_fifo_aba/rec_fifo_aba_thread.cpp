...
bool bABAWorkDo (void* pvWorkData, ST_BUFFERDATA* pstBufferData)
    ...
    bSpcMDemuxAnalogData (pstBufferData->pstCard, pstBufferData->pvABACurrentBuf, pstBufferData->llABAAvailBytes / pstBufferData->pstCard->lBytesPerSample, pstWorkData->ppnChData);
