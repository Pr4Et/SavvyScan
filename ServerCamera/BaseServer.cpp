...
//shahar, global vairbales from GUI to RecRepMulti.cpp
 ...
 char GUI_ImmediateDir[239]="d:\\SavvyscanData";
 char GUI_temp[239];
	...
	if (returnsize>=0)
	{
		...
		{	
			if (GUI_ch_update_ready)
			{
				...
				{
					sprintf(zmq_sub_buffer,"ch1=%d,ch2=%d,ch3=%d,ch4=%d,defocus=%d",GUI_ch1_avg,GUI_ch2_avg,GUI_ch3_avg,GUI_ch4_avg,GUI_defocus);
					PYTHON_ask_defocus=0;
				}
				else
					sprintf(zmq_sub_buffer,"ch1=%d,ch2=%d,ch3=%d,ch4=%d",GUI_ch1_avg,GUI_ch2_avg,GUI_ch3_avg,GUI_ch4_avg);
